...
public class RecMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.findEncodersByTypeAsync(VIDEO_AVC, new Utils.Callback() {
            ...
            public void onResult(MediaCodecInfo[] infos) {
                ...
                SpinnerAdapter codecsAdapter = RecMainActivity.this.createCodecsAdapter(mAvcCodecInfos);
                mVideoCodec.setAdapter(codecsAdapter);
                RecMainActivity.this.restoreSelections(mVideoCodec, mVieoResolution, mVideoFramerate, mIFrameInterval, mVideoBitrate);
        ...
        Utils.findEncodersByTypeAsync(AUDIO_AAC, new Utils.Callback() {
            ...
            public void onResult(MediaCodecInfo[] infos) {
                ...
                SpinnerAdapter codecsAdapter = RecMainActivity.this.createCodecsAdapter(mAacCodecInfos);
                mAudioCodec.setAdapter(codecsAdapter);
                RecMainActivity.this.restoreSelections(mAudioCodec, mAudioChannelCount);
            }
        });
